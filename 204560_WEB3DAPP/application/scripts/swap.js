...
function changeBack() {
    document.getElementById('bodyColor').style.backgroundColor = 'antiquewhite';
    document.getElementById('headerColor').style.backgroundColor = '#EE141B';
    document.getElementById('footerColor').style.backgroundColor = '#EE141B';
}